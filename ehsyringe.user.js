...
// @icon        https://cdn.jsdelivr.net/gh/EhTagTranslation/EhSyringe@7a309a53e52ee9dbefc49b7823d0100a10ed1e0f/src/assets/logo.svg
...
var package_namespaceObject = JSON.parse('{"name":"ehsyringe","displayName":"EhSyringe","version":"2.5.0","description":"E 站注射器，将中文翻译注入到 E 站体内。","author":"EhTagTranslation","scripts":{"start:monkey":"webpack serve --mode=development --env type=user-script","start:ext":"webpack --mode=development --watch --env type=web-ext","start:chrome":"yarn start:ext --env vendor=chrome","start:firefox":"yarn start:ext --env vendor=firefox","build":"webpack --mode=production","build:monkey":"yarn build --env type=user-script","build:ext":"yarn build --env type=web-ext","build:chrome":"yarn build:ext --env vendor=chrome && web-ext build -s dist -a releases -n ehsyringe.chrome.zip -o","build:firefox":"yarn build:ext --env vendor=firefox && web-ext build -s dist -a releases -n ehsyringe.firefox.xpi -o","lint":"eslint ./src/**/*.ts","format":"prettier --ignore-path .gitignore --write .","clean":"rimraf dist releases"},"repository":{"type":"git","url":"git+https://github.com/EhTagTranslation/EhSyringe.git"},"license":"MIT","bugs":{"url":"https://github.com/EhTagTranslation/EhSyringe/issues"},"readme":"https://github.com/EhTagTranslation/EhSyringe","homepage":"https://github.com/EhTagTranslation/EhSyringe","devDependencies":{"@babel/core":"^7.14.8","@babel/plugin-transform-runtime":"^7.14.5","@babel/preset-env":"^7.14.8","@types/chrome":"^0.0.148","@types/escape-html":"^1.0.1","@types/node":"^16.4.1","@types/tampermonkey":"^4.0.2","@typescript-eslint/eslint-plugin":"^4.28.4","@typescript-eslint/parser":"^4.28.4","babel-loader":"^8.2.2","copy-webpack-plugin":"^9.0.1","css-loader":"^6.2.0","cssnano":"^5.0.7","eslint":"^7.31.0","eslint-config-prettier":"^8.3.0","eslint-plugin-prettier":"^3.4.0","execa":"^5.1.1","file-loader":"^6.2.0","html-webpack-plugin":"^5.3.2","less":"^4.1.1","less-loader":"^10.0.1","postcss":"^8.3.6","postcss-import":"^14.0.2","postcss-loader":"^6.1.1","postcss-preset-env":"^6.7.0","prettier":"^2.3.2","rimraf":"^3.0.2","semver":"^7.3.5","style-loader":"^3.2.1","ts-loader":"^9.2.4","tsconfig-paths-webpack-plugin":"^3.5.1","type-fest":"^1.2.2","typescript":"^4.3.5","url-loader":"^4.1.1","web-ext":"^6.2.0","webpack":"^5.46.0","webpack-bundle-analyzer":"^4.4.2","webpack-cli":"^4.7.2","webpack-dev-server":"^3.11.2","webpack-userscript":"^2.5.8","webpack-webextension-plugin":"^0.4.1","yargs":"^17.0.1"},"dependencies":{"core-js":"^3.15.2","emoji-regex":"^9.2.2","escape-html":"^1.0.3","idb-keyval":"^5.0.6","lit-html":"^1.4.1","normalize.css":"^8.0.1","rxjs":"^7.2.0","tslib":"^2.3.0","typedi":"^0.10.0","webextension-polyfill-ts":"^0.26.0"}}');
...
var MenuProvider = /*#__PURE__*/function () {
  ...
  _createClass(MenuProvider, [{
    ...
    value: function createMenu(info) {
      ...
      el.setAttribute('icon', logo.default);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(9806), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
...
/******/ 	var __webpack_exports__ = __webpack_require__(4195);
/******/ 	
/******/ })()
;
